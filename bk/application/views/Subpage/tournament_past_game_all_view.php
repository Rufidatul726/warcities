                                        ...
                                        <tr>
                                            ...
                                            <?php if ($status === "DISABLE") : ?>
                                                <td style="vertical-align: middle;">
                                                    <?php echo anchor('Call_controller/fileDownload/' . $result . '/' . $id . '', 'DETAILS <i class="fa fa-list" aria-hidden="true"></i>', 'class="btn btn-dark"'); ?>
                                                </td>
                                            <?php else: ?>
                        ...
                        <?php else : ?>
                                ...
                                <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;"><?php echo $tperson; ?></span></td>
