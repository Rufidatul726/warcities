        ...
        <div class="center-container reguserbackground">
            <div class="main">
                ...
                <div class="w3layouts_main_grid">
                    <?php $attributes = array('class' => 'w6_form_post', 'id' => 'regform', 'name' => 'regform'); ?>
                        ...
                        <div class="col col-md-9">
                            <div class="w3_agileits_main_grid w3l_main_grid">
                                <span class="agileits_grid">
                                    ...
                                    <select name= "game_name" id= "gameName class="text-center">
                                        <option value="farlight">Farlight 84</option>
