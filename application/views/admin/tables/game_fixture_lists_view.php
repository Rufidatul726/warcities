...
<body>
    <div class="container-fluid">
        <?php echo form_open_multipart('admin/validation/Add_Game_Form_Validate_Controller/validateGameFixture'); ?>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6 col-md-offset-3">
                    <h1>Fixtures for - <?php echo $gamename; ?></h1>
                </div>
            </div>
            <div class="row">
                <div class="text-center col-md-3 col-sm-3 col-xs-3 col-lg-3 col-md-offset-1">     
                    <textarea id="mytextarea" cols="60" rows="30" name="fixtureDescription"><?php echo $fixtureDescription; ?></textarea>
                </div>
