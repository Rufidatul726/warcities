...
<head>
    ...
    <body>
        <h3 class="text-center"> TOURNAMENT  Assign Form</h3>
        <br>
        <?php $attributes = array('id' => 'demo-form2', 'class' => 'form-horizontal form-label-left', 'name' => 'myform', 'onsubmit' => 'return  validation()'); ?>
        <?php echo form_open_multipart('admin/validation/Add_Game_Form_Validate_Controller/validateAssignTournament', $attributes); ?>
        <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Game <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <select name="tournament" class="form-control col-md-7 col-xs-12">
        ...
        <?php //echo '<pre>';print_r($sub_cotent_subtournament);die(); ?>
        
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tournament <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <select name="subtournament" class="form-control col-md-7 col-xs-12">
