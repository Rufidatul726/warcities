...
<div class="container-fluid">
  <div class="row">
    <div class=" col-md-4 col-sm-4 col-sm-4 col-xs-4">    
      <h2 class="text-center">Tournament by Game</h2>
    </div>  
...
<!--                <div class="col-md-4 col-sm-4 col-sm-4 col-xs-6">
            ...
            <br>
            <div class="text-center ">
                <a href="<?php echo base_url() ?>browser" style="color: white;"class="hvr-bounce-out text-center btn btn-danger ">Load More</a>
            </div>
        </div>
        <hr>
        ...
        <div class="container-fluid">
            <div class="endContentBox">
                ...
                <div class="row">
                   ...
                   <div class="col-md-3 col-sm-3 col-sm-3 col-xs-3">
                       ...
                       <div style="color: red; padding: 10px 10px;"class="secondContentBox">
                           <br>
                           <h2 class="text-center">All Participant Management</h2>
                ...
                <div class="row">
                   <div class="col-md-8 col-sm-8 col-sm-8 col-xs-8"></div>
                   <div class="col-md-3 col-sm-3 col-sm-3 col-xs-3">
                       <br><br>
