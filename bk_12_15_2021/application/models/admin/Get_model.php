...
class Get_model extends CI_Model {
    ...
    public function getSingleFixture($id) {
        $this->db->select('*');
 ...
 public function getAllIteamsPageignation($tableName,$limit,$ofset) {
    ...
    public function leaderBoardtListBySingleGame($tableName, $id) {
        $newTableName = $tableName;
        $newid = $id;

        if ($id != '')
            $this->db->where('game', $newid);
    ...
    public function leaderBoardtListById($tableName, $id) {
        $newTableName = $tableName;
        $newid = $id;
    ...
    public function getAllTournament($tableName) {
        $newTableName = 'tournament';
        $this->db->where('editor', $this->session->userdata('id'));
    ...
    public function getDataForEditForEditor($tableName, $id) {
        $newTableName = $tableName;
        $newid = $id;
        if ($id != '')
            $this->db->where('id', $newid);
    ...
    public function getDataForEditIndexDesending($tableName, $index,$indexValue='', $editor='') {
        $newTableName = $tableName;
...
//        $this->db->or_like('description', $ItemExist,'both');
    ...
    public function searchSubTournament($id, $searchText) {
        $this->db->like($searchText,'', 'both');
        $this->db->where('id', $id);
        $query = $this->db->get('subtournament');
        $result = $query->result_array();
        return $result;
    }
