        ...
        <div class="row">
            <!-- <div class="text-center col-md-3 col-sm-3 col-xs-3 col-lg-3">     
                ...
                <div class="form-group">
                    <label class="control-label " for="first-name">Rules & Regulation <span class="required">*</span></label>
                    <div class="form-group">
                ...
                <?php echo form_close(); ?> 
                <a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>admin/delate/Admin_Erase_Conrtroller/delateAnyDataContent/<?php echo $newTableName; ?>/<?php echo $id; ?>">Delete <i class="fa fa-trash"></i>
                </a>
            </div> -->
            ...
            <!-- <div class="text-center col-md-3 col-sm-3 col-xs-3 col-lg-3">
                ...
                <?php $newTableName = "fixture"; ?>
                    <div class="form-group">
                        <label class="control-label " for="first-name">Fixture<span class="required">*</span></label>
                        <div class="form-group">
                    ...
                    <td class=" text-center">
                        <?php
                            ...
                            foreach($tags as $taggi){
                                echo '<span class="badge badge-secondary">'.$taggi.'</span>.';  
                            }
                        ?> 
                    </td>
