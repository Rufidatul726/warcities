...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="text-center col-md-3 col-sm-3 col-xs-3 col-lg-3">   
            ...
            <div class="form-group">
                <label class="control-label " for="first-name">Point<span class="required">*</span></label>
                <div class="form-group">
        ...
        <table class="table table-striped jambo_table bulk_action table-responsive">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title text-center">MLBB NAME </th>
                            ...
                            <th class="column-title text-center"> PLAYER 1</th>
                            <th class="column-title text-center"> PLAYER 2</th>
                            <th class="column-title text-center"> PLAYER 3</th>
                            <th class="column-title text-center"> PLAYER 4</th>
                            <th class="column-title text-center"> PLAYER(substitute)</th>
                          ...
                          <tr class="even pointer">
                           ...
                           <td style="vertical-align: middle;" class=" text-center"><?php echo $teamName; ?> </td>
                            <?php foreach ($sub_player as $row): ?>
                                    <?php $playerid = $row['id']; ?>
                                    <?php $pubgid = $row['mlbbid']; ?>
                                    <?php $mainid = $row['teamleadid']; ?>
                                    <?php $subtid = $row['subtid']; ?>
                            <?php if ($userid === $mainid): ?>
                                <td style="vertical-align: middle;" class=" text-center">  
                                <?php echo $pubgid; ?> <wbr>
                                <?php echo anchor('admin/edit/Admin_Edit_conrtroller/mlbbTeamListEdit/' . $pubgsubTable . '/' . $playerid . '', '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info btn-xs"'); ?>
                                </td>
                            <?php endif; ?>
                            <?php endforeach; ?>
                            ...
                            <td class="text-center ">
                                <?php echo anchor('admin/edit/Admin_Edit_conrtroller/mlbbListEdit/' . $newtablename . '/' . $id . '', 'EDIT <i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>  &nbsp;
