      ...
      <tbody>
        <tr class="even pointer">                      
          ...
          <td class="text-center ">
            <?php echo anchor('admin/edit/Admin_Edit_conrtroller/mainTournametListEdit/' . $newtablename . '/' . $id . '', 'EDIT <i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>
            &nbsp; 
            <?php echo anchor('admin/Admin_Load_controller/tournametListAactivate/' . $newtablename . '/' . $id . '', 'ACTIVE', 'class="btn btn-success"'); ?>  &nbsp; 
            <?php echo anchor('admin/Admin_Load_controller/tournametListDeactivate/' . $newtablename . '/' . $id . '', 'DISABLE ', 'class="btn btn-default"'); ?>  &nbsp; 
            <?php echo anchor('admin/Admin_Load_controller/subtournametList/' . $subtablename . '/' . $id . '', 'DETAILS <i class="fa fa-list" aria-hidden="true"></i>', 'class="btn btn-primary"'); ?>&nbsp;
            </td>
          </tr>
        </tbody>
        <?php $no = $no + 1; ?>
