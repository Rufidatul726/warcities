    ...
    <tbody>
      <tr class="even pointer">
        ...
        <td class="text-center ">
          <?php echo anchor('admin/validation/Add_Game_Form_Validate_Controller/validatePaymentConfirm/' . $newtablename . '/' . $id . '/' . $Paid . '', 'PAID <i class="fa fa-money" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>  
          &nbsp;
