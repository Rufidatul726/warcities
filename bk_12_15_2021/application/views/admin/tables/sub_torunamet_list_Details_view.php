        ...
        <tbody>
            <tr class="even pointer">
                ...
                <td class="text-center ">
                    <?php echo anchor('admin/Admin_Load_controller/gameRegList/' . $newtablename . '/'.$Name.'/' . $id . '', 'DETAILS <i class="fa fa-list" aria-hidden="true"></i>', 'class="btn btn-primary"'); ?>&nbsp; 
                    <?php echo anchor('admin/Admin_Load_controller/gameRegRuleLists/' . $newtablename . '/'.$Name.'/' . $id . '', 'Rules <i class="fa fa-chevron-circle-right" aria-hidden="true"></i>', 'class="btn btn-info"'); ?>&nbsp;
                    <?php echo anchor('admin/Admin_Load_controller/gameRegFixtureLists/' . $newtablename . '/'.$Name.'/' . $id . '', 'Fixture <i class="fa fa-database" aria-hidden="true"></i>', 'class="btn btn-warning"'); ?>&nbsp;
                </td>                
            </tr>                  
        </tbody>
