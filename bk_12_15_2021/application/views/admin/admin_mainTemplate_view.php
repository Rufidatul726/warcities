        ...
        <div class="left_col scroll-view">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-users"></i>User <span class="fa fa-chevron-down"></span></a>
                  ...
                  <!--  <li><a href="<?php echo base_url() ?>admin/Admin_Load_controller/gameAddForm">Add Game</a></li>-->
                    ...
                    <li><a href="<?php echo base_url() ?>admin/Admin_Load_controller/editorListView">Editor List</a></li>
                  </ul>
                </li>
              </ul>
            </div>
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-trophy"></i> Tournament <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="<?php echo base_url() ?>admin/Admin_Load_controller/tournametListDetails/<?php echo "yeap" ?>">TOURNAMENT DETAILS</a></li>
                    <?php }else{ ?>
            ...
            <div class="menu_section">
              <h3>Leader Board</h3>
              <ul class="nav side-menu">
                <li><a><i class="fa fa-trophy"></i> Leaderboard <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li ><a  href="<?php echo base_url() ?>admin/Admin_Load_controller/addLeaderboardTournamentRegForm"  > Add Leaderboard</a></li>
                    <li><a href="<?php echo base_url() ?>admin/Admin_Load_controller/leaderBoardtListGroupByGame">Leaderboard List</a></li>
                  </ul>
                </li>
              </ul>
            </div>
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-envelope"></i> Request List <span class="fa fa-chevron-down"></span></a>
                 <ul class="nav child_menu">
                   <li ><a  href="<?php echo base_url() ?>admin/Admin_Load_controller/requestForTournamet"  > Tournament</a></li>
                   </ul>
                </li>
              </ul>
            </div>
            ...
            <?php } if ($this->session->userdata('role') == 'ADMIN') { ?>
            <div class="menu_section">
              <h3>Editor's Section</h3>
              <ul class="nav side-menu">
                <li><a><i class="fa fa-image"></i> Tournament <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li ><a  href="<?php echo base_url() ?>admin/Admin_Load_controller/addslide"  > Add Slide</a></li>
                  </ul>
                </li>
