...
<html lang="en-us">
                ...
                <div class="w3layouts_main_grid">
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            <label> Name </label>
                            <input type="text" name="playerName" placeholder=" Name " id="playerName" required="" onblur="return pname();">
                            <span  class="text-center"id="playerNameError"></span>
                        </span>
                    </div>
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            ...
                            <input type="text" name="team_name" id="mobile" placeholder="Team Name" required="">
                        </span>
                    </div>
                    ...
                    <div class="w3_agileits_main_grid w3l_main_grid">
                        <span class="agileits_grid">
                            ...
                            <input type="text" name="leader_tag_id" id="mobile"placeholder="Leader Tag Id" required="">
                        </span>
                    </div>


                    <button type="button" name="add" id="add" class="btn btn-info"><i class="fa fa-plus"></i> Add Team Mate Tag Id</button>
    ...
    <script type='text/javascript'>
            ...
            $("#add").click(function(){
              i++;
                $('#dynamic_field').append('<div class="w3_agileits_main_grid w3l_main_grid" id="row'+i+'">\
                    <span class="agileits_grid">\
                        <label><button type="button" name="remove" id="'+i+'" class="btn btn-warning btn_remove">Remove</button> </label>\
                        <input type="text" name="gameTagid[]" placeholder=" Game Tag Id ('+(i)+')" id="gameTagid" required="" onblur="return gameTagId();"><span  class="text-center"id="gameTagidError"></span>\
                    </span>\
                </div>');
            });
