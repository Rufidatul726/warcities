    ...
    <div class="background">
        ...
        <?php $attributes = array('id' => 'myform', 'name' => 'myform', 'onsubmit' => 'return Test()'); ?>
          <?php echo form_open('Login_Validate_controller/loginValidate', $attributes); ?>
            ...
            <div class="form-group"><a href="<?php echo $google_client->createAuthUrl() ?>" class="btn btn-block"> <img src="<?= base_url()?>asset/image/logo/google_logo.png"/> Log In with Google</a></div>
